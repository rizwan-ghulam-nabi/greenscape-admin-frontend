// app/admin/dashboard/orders/shipped/page.js
'use client';
...
export default function ShippedOrdersPage() {
  ...
  const fetchOrders = async () => {
    try {
      setLoading(true);
      const res = await axios.get(`${API_BASE_URL}/orders?status=shipped`, {
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Manage orders that have been shipped
          </p>
        </div>
        <button
          onClick={fetchOrders}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-gray-500">Total Shipped</p>
                ...
                <tr>
                  <td colSpan="7" className="px-6 py-12 text-center text-gray-500">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-gray-600 font-medium">No shipped orders found</p>
                    </div>
                  </td>
                </tr>
              ) : (
                  ...
                  <tr key={order._id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-4">
                      <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium border ${getOrderStatusBadge(order.orderStatus)}`}>
                        {getOrderStatusIcon(order.orderStatus)} {order.orderStatus || 'Shipped'}
                      </span>
                    </td>
