...
if (typeof window !== 'undefined') {
  ...
  console.log('🔍 RAW_API_URL (after fallback):', RAW_API_URL);
}
// -----------------------------------------
...
if (typeof window !== 'undefined') {
  console.log('🔍 AdminChatbot API base:', API_BASE_URL);
  console.log('🔍 Chat endpoint will be:', `${API_BASE_URL}/api/admin/chat/message`);
}
...
export default function AdminChatbot() {
  ...
  const handleSend = async (text) => {
    ...
    try {
      // ✅ Correct URL: <backend>/api/admin/chat/message
      const url = `${API_BASE_URL}/api/admin/chat/message`;
      console.log('📤 Sending to:', url);
